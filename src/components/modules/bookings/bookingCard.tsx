...
export function BookingCard({
  ...
  return (
    <>
      <div className="relative flex flex-col rounded-2xl border border-border/60 bg-card overflow-hidden shadow-xs hover:shadow-sm transition-all duration-300 group">
