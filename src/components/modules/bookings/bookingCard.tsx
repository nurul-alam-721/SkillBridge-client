...
export function BookingCard({
  ...
  return (
    <>
      <div className="relative flex flex-col rounded-2xl border border-border/60 bg-card overflow-hidden shadow-xs hover:shadow-md transition-all duration-300 group">
        ...
        <div className="relative p-5 flex flex-col gap-4">
          <div className="flex items-start justify-between gap-3">
            ...
            <span
              className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[11px] font-semibold shrink-0 ${cfg.pill}`}
            >
      ...
      {/* Review dialog — rendered outside the card */}
      <LeaveReviewDialog
        open={reviewOpen}
        booking={booking}
